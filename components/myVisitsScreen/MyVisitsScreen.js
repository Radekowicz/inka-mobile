  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.toggleContainer}>
        ...
        >
          <Text style={isClicked ? styles.clicked : styles.notClicked}>Następna wizyta</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => {
        ...
        >
          <Text style={isClicked ? styles.notClicked : styles.clicked}>Poprzednie wizyty</Text>
        </TouchableOpacity>
      </View>

      <Stack.Navigator screenOptions={{ headerShown: true }}>
        <Stack.Screen name="NextVisit" component={MakeNextVisit} options={{ headerShown: false }} />
        <Stack.Screen name="MyVisits" component={MakeMyVisits} options={{ headerShown: false }} />
      </Stack.Navigator>
    </SafeAreaView>
  )
}
